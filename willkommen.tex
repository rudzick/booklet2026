...
\begin{flushright}
\includegraphics[width=1.0\textwidth]{FOSSGIS}
\end{flushright}
...
\section*{Fotos und Social Media}\label{Fotos und Social Media}
Wir freuen uns, wenn Sie Beiträge über die FOSSGIS-Konferenz in Social Media posten! Bitte verwenden Sie als Hashtags\linebreak \texttt{\#fossgis2026} und ggf. \texttt{\#openstreetmap}. Falls Sie Fotos von Personen veröffentlichen denken Sie bitte daran, vorher deren Einverständnis einzuholen.
\newpage
\section*{Exkursionen {\normalfont\em (Anmeldung erforderlich)}}\label{exkursionen}
\noindent
{\large \bfseries Führung durch das Rechenzentrum der GWDG}\\
Das Rechenzentrum der Gesellschaft für wissenschaftliche Datenverarbeitung mbH Göttingen (GWDG) fungiert als Hochschulrechenzentrum für die Georg-August-Universität Göttingen und Rechen- und IT-Kompetenzzentrum für die Max-Planck-Gesell\-schaft. Die Führung gibt einen kurzen Überblick die Dienstleistungen der GWDG sowie über die technische Ausstattung.
...
\input{sponsorentexte/602_alteweissemaenner.tex}
...
Am {\bfseries Donnerstag} sind alle Mitglieder und Gäste ab {\bfseries 19.00 Uhr} herzlich zur Mitgliederversammlung des FOSSGIS e.V. eingeladen.  Der Verein freut sich über zahlreiches Erscheinen.

\newpage
\section*{Rahmenprogramm am Freitag}

\subsection*{Sektempfang am FOSSGIS-Stand}
Alle Mitglieder des FOSSGIS-Vereins, Freunde und Interessierte sind am {\bfseries Freitag} ab {\bfseries 16:00 Uhr} herzlich zum Sektempfang zum Ausklang der FOSSGIS 2026 am FOSSGIS-Vereins-Stand eingeladen.

\subsection*{OSM-Event am Freitagabend}
Zur Einstimmung auf den OSM-Samstag sind am {\bfseries Freitagabend}  ab {\bfseries 18:30 Uhr} im {\em Kartoffelhaus} Plätze reserviert. Adresse: Goethe\-allee~8. Es gibt Essen sowie Getränke, jede:r bezahlt seine Rechnung selbst. Zur besseren Planung wird um Eintragung im OSM-Wiki gebeten.
\newpage
\section*{Programm am Samstag}
\noindent
Die Veranstaltungen am Samstag finden im {\bfseries Geographischen Institut}, Goldschmidtstr. 3-5,
37073 Göttingen, statt.

\subsection*{OSM-Samstag}
Am {\bfseries Samstag}, den 28.~März findet von {\bfseries 9.00} bis {\bfseries 17.30}~Uhr die OSM-Unkonferenz statt.
...
Die Veranstaltung startet um {\bfseries 9:00}~Uhr mit einem kurzen Vortrag, der für Einsteiger:innen
...
eingetragen werden. Es ist auch eine Beteiligung an der Initiative \glqq QGIS-Plugins für Qt6/QGIS4\grqq möglich.
Um Anmeldung über das FOSSGIS-Konferenz-Anmeldesystem wird gebeten.
