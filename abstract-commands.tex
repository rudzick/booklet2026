...
\def\freitag{Freitag}
\def\samstag{Samstag}
\def\posterausstellung{Posterausstellung}
...
% define Posterausstellung page style
\newpairofpagestyles[scrheadings]{posterausstellung}{}
\AddLayersAtBeginOfPageStyle{posterausstellung}{postereven}
\AddLayersAtBeginOfPageStyle{posterausstellung}{posterodd}
...
\newcommand{\setPageBackground}{%
  ...
  \ifthenelse{\equal{\conferenceDay}{\posterausstellung}}{%
    \pagestyle{posterausstellung}%
  }{}%
...
\definecolor{fossgis}{cmyk}{0.0 0.47 1.0 0.07}
\definecolor{grass}{HTML}{cdebb0}
\definecolor{forest}{HTML}{add19e}
\definecolor{water}{HTML}{aad3df}
\definecolor{farmland}{HTML}{eef0d5}
...
\newcommand{\BoFeins}{\cellcolor{eins}\scalebox{0.7}[1.0]{Anw./BoF1\,(ZHG 001)}}
...
\newcommand{\BoFzwei}{\cellcolor{zwei}\scalebox{0.7}[1.0]{Anw./BoF2\,(ZHG 005)}}

% abstract at Anwendertreffen | BoF3/Exp
\DeclareRobustCommand*{\abstractAnwBoFdrei}[4]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{audimax}{BoF3/Exp. (ZHG 006)}
}
% table heading for BoF3/Exp
\newcommand{\BoFdrei}{\cellcolor{audimax} \scalebox{0.7}[1.0]{Exp./BoF3(ZHG 006)}}

% abstract for poster
\DeclareRobustCommand*{\abstractPoster}[5]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{farmland}{Poster #5}
}

% table heading for FOSSGIS MV
\newcommand{\FOSSGISMV}{\cellcolor{fossgis} BoF\,1\,(ZHG\,001)}

% table heading for MN 09
\newcommand{\MNa}{\cellcolor{water} Opening\,OSM\,(MN\,09)}
% table heading for MN 10
\newcommand{\MNb}{\cellcolor{grass} OSM\,2\,(MN\,10)}
% table heading for MN 11
\newcommand{\MNc}{\cellcolor{forest} OSM\,1\,(MN\,11)}
...
% abstract at a different location
\newcommand{\abstractFOSSGIS}[5]%
{%
  \setAbstract{#1}{#2}{#3}{#4}{fossgis}{#5}
}
