 ...
 voffset=9.5mm,%
  contents={%
    \begin{tikzpicture}[x=1mm, y=1mm]%
      % map image
      \draw (0,0) node [inner sep=0mm, anchor=south west] {%
        \includegraphics[height=149mm,angle=0,origin=c]{images-print/2026-02-12_goettingen.pdf}%
%        \includegraphics[width=149mm,angle=90,origin=c]{images-print/2026-02-12_goettingen.pdf}%
